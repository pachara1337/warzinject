...
//	cid.UniqueThread = 0;
//
//	NtOpenProcess(&hProcess, PROCESS_CREATE_THREAD | PROCESS_QUERY_INFORMATION | PROCESS_VM_OPERATION | PROCESS_VM_READ | PROCESS_VM_WRITE, &oa, &cid);
//
...
//	if (!NT_SUCCESS(status = NtWriteVirtualMemory(hProcess, image, buffer, pINH->OptionalHeader.SizeOfHeaders, NULL)))
//	{
//
...
//	RtlCreateUserThread(hProcess, NULL, FALSE, 0, 0, 0, (PVOID)((PMANUAL_INJECT)mem + 1), mem, &hThread, NULL);
